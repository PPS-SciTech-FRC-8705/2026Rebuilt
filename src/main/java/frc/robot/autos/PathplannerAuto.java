...
public class PathplannerAuto extends SequentialCommandGroup {
  ...
  public PathplannerAuto(CommandSwerveDrivetrain driveSubsystem, CANFuelSubsystem ballSubsystem, ClimberSubsystem climbersubsystem) {
    ...
    addCommands(
        ...
        new ClimbUp(climbersubsystem).withTimeout(7)
    );
  }
}